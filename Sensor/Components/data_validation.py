...
class DataValidation:
    def __init__(self,
                 ...
                 data_ingestion_artifact:artifact_entity.DataIngestionArtifact):  # we need to pass
        try:
    ...
    def drop_missing_values_columns(self, df:pd.DataFrame, report_key_name:str)->Optional[pd.DataFrame]:
        #Here using option since it also can be return null value
        """
        This function will drop column which contains missing value more than specified threshold
        df: Accepts a pandas dataframe
        threshold: Percentage criteria to drop a column
        =====================================================================================
        returns Pandas DataFrame if atleast a single column is available after missing columns drop else Return None
        """
        #If It Return None means Null therefore using option

        try:
            threshold = self.data_validation_config.missing_threshold
            null_report = df.isna().sum()/df.shape[0]
            #Selecting Column Names which containing null values 
            logging.info(f"Selecting Column Names which containing null values above to {threshold}")
    ...
    def is_required_columns_exists(self, base_df:pd.DataFrame, current_df:pd.DataFrame, report_key_name:str)-> bool:
        try:
            ...
            if len(missing_columns) > 0 :
                ...
                return False
            return True # Return true if all columns are present        
    ...
    def data_drift(self, base_df:pd.DataFrame,current_df:pd.DataFrame, report_key_name:str) :
        ...
        #Null Hypothesis Both Column Data Drawn from Same Distribution
            if same_distribution.pvalue > 0.05 :
                #wwe Are Accepting Null Hypothesis
               ...
               drift_report[base_column] = {
                    "pvalues" : float(same_distribution.pvalues),
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            base_df = self.drop_missing_values_columns(df=base_df, report_key_name ="missing_values_within_base__dataset")
